////////////////////////////////////////////////////////////////////////////////
//! \file pe_agent_driver.c
//! \brief PE agent driver
//!
//! \Purpose:
//!     Memory optimization. In some cases, user application will get crashed and
//! then terminated by system without any chance to call graceful exit function.
//! Use pe agent device to avoid the resources leakage in PE server side.
//!
//! \Version, Date and Author :
//!     V 1.00, 02-08-2012  ,  Chang Liu
//!
//!
//! Note:
////////////////////////////////////////////////////////////////////////////////
