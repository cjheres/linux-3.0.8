/** @file  wfdutl.h
 *
 *  @brief Header file for wfdutl application
 *
...
/** Convert WFD header from little endian format to CPU format */
#define endian_convert_tlv_wfd_header_in(x)             \
    {                                               \
...
#define MRVL_WFD_DISC_PERIOD_TLV_ID          (PROPRIETARY_TLV_BASE_ID + 0x7c)   // 0x017c
/** TLV: Wfd Scan Enable */
#define MRVL_WFD_SCAN_ENABLE_TLV_ID          (PROPRIETARY_TLV_BASE_ID + 0x7d)   // 0x017d
/** TLV: Wfd Peer Device  */
#define MRVL_WFD_PEER_DEVICE_TLV_ID          (PROPRIETARY_TLV_BASE_ID + 0x7e)   // 0x017e
/** TLV: Wfd Scan Request Peer Device  */
#define MRVL_WFD_SCAN_REQ_DEVICE_TLV_ID      (PROPRIETARY_TLV_BASE_ID + 0x7f)   // 0x017f
/** TLV: Wfd Device State */
#define MRVL_WFD_DEVICE_STATE_TLV_ID         (PROPRIETARY_TLV_BASE_ID + 0x80)   // 0x0180
/** TLV: Wfd Intent */
#define MRVL_WFD_INTENT_TLV_ID               (PROPRIETARY_TLV_BASE_ID + 0x81)   // 0x0181
/** TLV: Wfd Capability */
#define MRVL_WFD_CAPABILITY_TLV_ID           (PROPRIETARY_TLV_BASE_ID + 0x82)   // 0x0182
/** TLV: Wfd Notice of Absence */
#define MRVL_WFD_NOA_TLV_ID                  (PROPRIETARY_TLV_BASE_ID + 0x83)   // 0x0183
/** TLV: Wfd Opportunistic Power Save */
#define MRVL_WFD_OPP_PS_TLV_ID               (PROPRIETARY_TLV_BASE_ID + 0x84)   // 0x0184
/** TLV: Wfd Invitation list */
#define MRVL_WFD_INVITATION_LIST_TLV_ID      (PROPRIETARY_TLV_BASE_ID + 0x85)   // 0x0185
/** TLV: Wfd Listen channel */
#define MRVL_WFD_LISTEN_CHANNEL_TLV_ID       (PROPRIETARY_TLV_BASE_ID + 0x86)   // 0x0186
/** TLV: Wfd Operating Channel */
#define MRVL_WFD_OPERATING_CHANNEL_TLV_ID    (PROPRIETARY_TLV_BASE_ID + 0x87)   // 0x0187
/** TLV: Wfd Persistent Group */
#define MRVL_WFD_PERSISTENT_GROUP_TLV_ID     (PROPRIETARY_TLV_BASE_ID + 0x88)   // 0x0188
/** TLV: Wfd Presence request parameters */
#define MRVL_WFD_PRESENCE_REQ_PARAMS_TLV_ID  (PROPRIETARY_TLV_BASE_ID + 0x8d)   // 0x018d
/** TLV: Wfd Extended Listen Time */
#define MRVL_WFD_EXTENDED_LISTEN_TIME_TLV_ID (PROPRIETARY_TLV_BASE_ID + 0x8e)   // 0x018e
/** TLV: Wfd Provisioning parameters */
#define MRVL_WFD_PROVISIONING_PARAMS_TLV_ID  (PROPRIETARY_TLV_BASE_ID + 0x8f)   // 0x018f
/** TLV: Wfd WPS parameters */
#define MRVL_WFD_WPS_PARAMS_TLV_ID           (PROPRIETARY_TLV_BASE_ID + 0x90)   // 0x0190
...
typedef enum
{
    ...
    WFD_DIALOGTOKEN,
    WFD_DISC_ADPROTOIE,
    WFD_GAS_COMEBACK_DELAY,
    WFD_DISC_INFOID,
    WFD_OUI,
    WFD_OUITYPE,
    WFD_OUISUBTYPE,
    WFD_SERVICEUPDATE_INDICATOR,
    WFD_DISC_SERVICEPROTO,
    WFD_DISC_SERVICETRANSACID,
    WFD_DISC_SERVICE_STATUS,
    WFD_MINDISCOVERYINT,
    WFD_MAXDISCOVERYINT,
    WFD_ENABLE_SCAN,
    WFD_DEVICE_STATE,
    WFD_INVITATIONFLAG,
    WFD_DISC_DNSTYPE,
    WFD_DISC_BONJOUR_VERSION,
    WFD_DISC_UPNP_VERSION,
    WFD_PRESENCE_REQ_TYPE,
} valid_inputs;
...
/** AP CMD header */
#define WFD_CMD_HEADER     /** Buf Size */         \
                        t_u32 buf_size;         \
                        /** Command Code */     \
                        t_u16 cmd_code;         \
                        /** Size */             \
...
/** TLV buffer : wfd IE WFD Group Info- Client Dev Info */
...
/** TLV buffer : wfd IE WFD Group Info */
...
typedef PACK_START struct _tlvbuf_wfd_wps_ie
{
    /** TLV Header tag */
    t_u16 tag;
    /** TLV Header length */
...
/** HostCmd_CMD_WFD_MODE_CONFIG */
typedef PACK_START struct _wfd_mode_config
{
    /** Header */
    WFD_CMD_HEADER;
    /** Action */
    ...
    /** wfd mode data */
    t_u16 mode;
} PACK_END wfd_mode_config;

/** HostCmd_CMD_WFD_PARAMS_CONFIG */
typedef PACK_START struct _wfd_params_config
{
    /** Header */
    WFD_CMD_HEADER;
    /** Action */
...
/** HostCmd_CMD_WFD_SERVICE_DISCOVERY request */
typedef PACK_START struct _wfd_discovery_request
{
    /** Header */
    WFD_CMD_HEADER;
    /** Peer mac address */
...
} PACK_END wfd_discovery_request;

/** HostCmd_CMD_WFD_SERVICE_DISCOVERY response */
typedef PACK_START struct _wfd_discovery_response
{
    /** Header */
    WFD_CMD_HEADER;
    /** Peer mac address */
...
} PACK_END wfd_discovery_response;

/** HostCmd_CMD_WFD_GAS_COMEBACK_SERVICE request */
typedef PACK_START struct _wfd_gas_comeback_request
{
    /** Header */
    WFD_CMD_HEADER;
    /** Peer mac address */
    ...
    /** Dialog taken */
    t_u8 dialog_taken;
} PACK_END wfd_gas_comeback_request;

/** HostCmd_CMD_WFD_GAS_COMEBACK_SERVICE response */
typedef PACK_START struct _wfd_gas_comeback_response
{
    /** Header */
    WFD_CMD_HEADER;
    /** Peer mac address */
    ...
    /** Response Data */
    wfd_response_data disc_resp;
} PACK_END wfd_gas_comeback_response;

/** HostCmd_CMD_WFD_ACTION_FRAME request */
typedef PACK_START struct _wfd_action_frame
{
    /** Header */
    WFD_CMD_HEADER;
    /** Peer mac address */
...
typedef PACK_START struct _tlvbuf_wfd_persistent_group
{
    /** Tag */
    t_u16 tag;
    /** Length */
...
} PACK_END tlvbuf_wfd_persistent_group;

/** TLV buffer : Wfd discovery period */
typedef PACK_START struct _tlvbuf_wfd_discovery_period
{
    /** Tag */
    t_u16 tag;
    /** Length */
...
} PACK_END tlvbuf_wfd_discovery_period;

/** TLV buffer : Wfd Intent */
typedef PACK_START struct _tlvbuf_wfd_intent
{
    /** Tag */
    t_u16 tag;
    /** Length */
    ...
    /** Intent value */
    t_u8 intent;
} PACK_END tlvbuf_wfd_intent;

/** TLV buffer : Wfd Invitation List */
typedef PACK_START struct _tlvbuf_wfd_invitation_list
{
    /** Tag */
    t_u16 tag;
    /** Length */
...
} PACK_END tlvbuf_wfd_invitation_list;

/** TLV buffer : Wfd Listen Channel */
typedef PACK_START struct _tlvbuf_wfd_listen_channel
{
    /** Tag */
    t_u16 tag;
    /** Length */
    ...
    /** Listen Channel */
    t_u8 listen_channel;
} PACK_END tlvbuf_wfd_listen_channel;

/** TLV buffer : Wfd Operating Channel */
typedef PACK_START struct _tlvbuf_wfd_operating_channel
{
    /** Tag */
    t_u16 tag;
    /** Length */
...
} PACK_END tlvbuf_wfd_operating_channel;

/** TLV buffer : Wfd NoA config */
typedef PACK_START struct _tlvbuf_wfd_noa_config
{
    /** Tag */
    t_u16 tag;
    /** Length */
    ...
    /** Interval */
    t_u32 interval;
} PACK_END tlvbuf_wfd_noa_config;

/** TLV buffer : wfd OppPS config */
typedef PACK_START struct _tlvbuf_opp_ps_config
{
    ...
    /** CTWindow and OppPS*/
    t_u8 ctwindow_opp_ps;
} PACK_END tlvbuf_wfd_opp_ps_config;

/** TLV buffer : wfd capability config */
typedef PACK_START struct _tlvbuf_capability_config
{
    ...
    /** Group capability */
    t_u8 group_capability;
} PACK_END tlvbuf_wfd_capability_config;

/** TLV buffer : Wfd Presence Request Parameters */
typedef PACK_START struct _tlvbuf_wfd_presence_req_params
{
    /** Tag */
    t_u16 tag;
    /** Length */
    ...
    /** Interval */
    t_u32 interval;
} PACK_END tlvbuf_wfd_presence_req_params;

/** TLV buffer : Wfd Extended Listen Timing parameters*/
typedef PACK_START struct _tlvbuf_mrvl_wfd_ext_listen_time
{
    /** Tag */
    t_u16 tag;
    /** Length */
    ...
    /** Interval */
    t_u16 interval;
} PACK_END tlvbuf_wfd_mrvl_ext_listen_time;

/** TLV buffer : Wfd Provisioning parameters*/
typedef PACK_START struct _tlvbuf_wfd_provisioning_params
{
    /** Tag */
    t_u16 tag;
    /** Length */
    ...
    /** config methods */
    t_u16 dev_password;
} PACK_END tlvbuf_wfd_provisioning_params;

/** TLV buffer : Wfd WPS parameters*/
typedef PACK_START struct _tlvbuf_wfd_wps_params
{
    /** Tag */
    t_u16 tag;
    /** Length */
    ...
    /** action */
    t_u16 action;
} PACK_END tlvbuf_wfd_wps_params;
...
/** OUI Type WFA WFD */
#define OUI_TYPE_WFA_WFD    9

/** Host Command ioctl number */
#define WFD_HOSTCMD          (SIOCDEVPRIVATE + 1)
...
#define HostCmd_CMD_WFD_SERVICE_DISCOVERY   0x00ec
/** Host Command ID:  WFD_ACTION_FRAME */
#define HostCmd_CMD_802_11_ACTION_FRAME             0x00f4

/** TLV : Wfd param capability */
#define TLV_TYPE_WFD_CAPABILITY           0x0002
/** TLV : Wfd param device Id */
#define TLV_TYPE_WFD_DEVICE_ID            0x0003
/** TLV : Wfd param group owner intent */
#define TLV_TYPE_WFD_GROUPOWNER_INTENT    0x0004
/** TLV : Wfd param config timeout */
#define TLV_TYPE_WFD_CONFIG_TIMEOUT       0x0005
/** TLV : Wfd param channel */
#define TLV_TYPE_WFD_CHANNEL              0x0006
/** TLV : Wfd param group bssId */
#define TLV_TYPE_WFD_GROUP_BSS_ID         0x0007
/** TLV : Wfd param extended listen time */
#define TLV_TYPE_WFD_EXTENDED_LISTEN_TIME 0x0008
/** TLV : Wfd param intended address */
#define TLV_TYPE_WFD_INTENDED_ADDRESS     0x0009
/** TLV : Wfd param manageability */
#define TLV_TYPE_WFD_MANAGEABILITY        0x000a
/** TLV : Wfd param channel list */
#define TLV_TYPE_WFD_CHANNEL_LIST         0x000b
/** TLV : Wfd Notice of Absence */
#define TLV_TYPE_WFD_NOTICE_OF_ABSENCE    0x000c
/** TLV : Wfd param device Info */
#define TLV_TYPE_WFD_DEVICE_INFO          0x000d
/** TLV : Wfd param Group Info */
#define TLV_TYPE_WFD_GROUP_INFO           0x000e
/** TLV : Wfd param group Id */
#define TLV_TYPE_WFD_GROUP_ID             0x000f
/** TLV : Wfd param interface */
#define TLV_TYPE_WFD_INTERFACE            0x0010
/** TLV : Wfd param operating channel */
#define TLV_TYPE_WFD_OPCHANNEL            0x0011
/** TLV : Wfd param invitation flag */
#define TLV_TYPE_WFD_INVITATION_FLAG      0x0012
