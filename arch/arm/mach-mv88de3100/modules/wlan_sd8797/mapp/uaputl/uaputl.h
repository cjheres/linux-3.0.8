...
typedef struct _tx_bf_cfg_para
{
    ...
    union
    {
        ...
        no_tx_args bf_no_tx[MAX_PEER_MAC_TUPLES];
...
/** TLV : Tx data rate */
#define MRVL_TX_DATA_RATE_TLV_ID        (PROPRIETARY_TLV_BASE_ID + 0x35)        // 0x0135
...
int check_channel_validity_11d(int channel, int set_domain);
