...
/** MAC action : Force 11n protection enable */
#define HostCmd_ACT_MAC_FORCE_11N_PROTECTION_ON   0x0800
...
#ifdef WFD_SUPPORT
/** WFD generic event */
#define EVENT_WFD_GENERIC_EVENT         0x00000049
...
typedef MLAN_PACK_START struct _HostCmd_DS_RX_DATA_PAUSE
{
    /** Action */
    t_u16 action;
    /** Reserved field */
    t_u16 rx_pause;
} MLAN_PACK_END HostCmd_DS_RX_DATA_PAUSE;
...
#ifdef WFD_SUPPORT
/** BSS Mode: WFD Client */
#define BSS_MODE_WFD_CLIENT 	0
/** BSS Mode: WFD GO */
#define BSS_MODE_WFD_GO     	2
#endif
...
/** tx_bf_trigger_sound_args_t */
typedef MLAN_PACK_START struct _tx_bf_trigger_sound_args_t
{
    /** Peer MAC address */
    t_u8 peer_mac[MLAN_MAC_ADDR_LENGTH];
    /** Status */
    t_u8 status;
} MLAN_PACK_END tx_bf_trigger_sound_args_t;

/** tx_bf_snr_thr_t */
typedef MLAN_PACK_START struct _tx_bf_snr_thr_t
{
    /** Peer MAC address */
    t_u8 peer_mac[MLAN_MAC_ADDR_LENGTH];
    /** SNR */
    t_u8 snr;
} MLAN_PACK_END tx_bf_snr_thr_t;
...
typedef MLAN_PACK_START struct _HostCmd_DS_TX_BF_CFG
{
    ...
    {
        /** TX beamforming interval */
        t_u32 interval;
        /** MAC address of the peer */
        t_u8 peer_mac[MLAN_MAC_ADDR_LENGTH];
        /** Any new subcommand should be inserted here */
        tx_bf_trigger_sound_args_t bf_sound_args;
        tx_bf_snr_thr_t bf_snr;
    } MLAN_PACK_END body;
