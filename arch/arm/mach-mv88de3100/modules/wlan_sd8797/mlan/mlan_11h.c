...
static const IEEEtypes_SupportChan_Subband_t wlan_11h_JPN_lower_band = { 8, 3 };

/** JPN sub-band config : Start Channel = 34, NumChans = 4 */
static const
    IEEEtypes_SupportChan_Subband_t wlan_11h_JPN_upper_band = { 34, 4 };
                              ...
                              IEEEtypes_SupportedChannels_t * psup_chan)
{
    ...
    if ((band & BAND_B) || (band & BAND_G)) {
        ...
        case 0x41:             /* Japan */
        case 0xff:             /* Japan special */
            psup_chan->subband[num_subbands++] = wlan_11h_JPN_lower_band;
            psup_chan->subband[num_subbands++] = wlan_11h_JPN_upper_band;
            break;
        }
    }
...
wlan_11h_radar_detect_required(mlan_private * priv, t_u8 channel)
{
    ...
    case 0x20:                 /* Canada IC */
        /*
         * Radar detection required in:
         *   5.250-5.350 (U-NII middle) band
         *   5.470-5.725 (U-NII mid-upper) band
         */
