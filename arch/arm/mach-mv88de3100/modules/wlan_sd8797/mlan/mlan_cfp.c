...
static chan_freq_power_t channel_freq_power_JPN_A[] = {
    ...
    {52, 5230, WLAN_TX_PWR_JP_DEFAULT},
    {56, 5230, WLAN_TX_PWR_JP_DEFAULT},
    {60, 5230, WLAN_TX_PWR_JP_DEFAULT},
    {64, 5230, WLAN_TX_PWR_JP_DEFAULT}
};

/** Band: 'A', Region: China */
static chan_freq_power_t channel_freq_power_CN_A[] = {
    {149, 5745, WLAN_TX_PWR_CN_2000MW},
    {153, 5765, WLAN_TX_PWR_CN_2000MW},
    {157, 5785, WLAN_TX_PWR_CN_2000MW},
    {161, 5805, WLAN_TX_PWR_CN_2000MW},
    {165, 5825, WLAN_TX_PWR_CN_2000MW}
};
