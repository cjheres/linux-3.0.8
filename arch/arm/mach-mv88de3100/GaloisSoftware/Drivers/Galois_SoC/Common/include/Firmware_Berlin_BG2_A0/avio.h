...
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #0.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00104 BCM_Q1               (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #1.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00108 BCM_Q2               (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #2.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x0010C BCM_Q3               (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #3.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00110 BCM_Q4               (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #4.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00114 BCM_Q5               (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #5.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00118 BCM_Q6               (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #6.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x0011C BCM_Q7               (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #7.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00120 BCM_Q8               (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #8.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00124 BCM_Q9               (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #9.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00128 BCM_Q10              (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #10.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x0012C BCM_Q11              (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #11.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00130 BCM_Q14              (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #14.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00134 BCM_Q15              (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #15.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00138 BCM_Q16              (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #16.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x0013C BCM_Q17              (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #17.
///                                    ###
///               %%        27         # Stuffing bits...
///     @ 0x00140 BCM_Q18              (P)
///               %unsigned 5  mux                       0xF
///                                    ###
///                                    * This mux is used todefine the mapping between the interrupt and the BCM queue #18.
///                                    ###
///               %%        27         # Stuffing bits...
...
///               %unsigned 1  Q18                       0x0
///                                    ###
///                                    * This bit is used to indicate the full status of each queue. One bit is assigned per queue. SW should poll this queue before programming the queue. If the queue is full and SW programs the queue, data will be lost.
///                                    ###
///               %%        13         # Stuffing bits...
...
///               %unsigned 1  Q18                       0x0
///                                    ###
///                                    * This bit is used to indicate the empty status of each queue.
///                                    ###
///               %%        13         # Stuffing bits...
///     @ 0x0014C                      (W-)
///     #         # Stuffing bytes...
///               %% 1440
///     # # ----------------------------------------------------------
/// $ENDOFINTERFACE  # size:     512B, bits:     155b, padding:     0B
////////////////////////////////////////////////////////////
#ifndef h_AVIO
#define h_AVIO (){}
