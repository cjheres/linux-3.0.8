...
//	printk(KERN_ALERT "Service ID =  0x%08x | Srv = %08x | %02x, %02x, %02x, %02x, %02x, %02x, %02x, %02x\n",
//				pData->m_ServiceID,  *(((unsigned int *)pData) + 1),
//				pData->m_Data[0], pData->m_Data[1], pData->m_Data[2], pData->m_Data[3],
//				pData->m_Data[4], pData->m_Data[5], pData->m_Data[6], pData->m_Data[7]
//				);
#else
//	printf("Service ID =  0x%08x | Srv = %08x | %02x, %02x, %02x, %02x, %02x, %02x, %02x, %02x\n",
//				pData->m_ServiceID,  *(((unsigned int *)pData) + 1),
//				pData->m_Data[0], pData->m_Data[1], pData->m_Data[2], pData->m_Data[3],
//				pData->m_Data[4], pData->m_Data[5], pData->m_Data[6], pData->m_Data[7]
//				);
